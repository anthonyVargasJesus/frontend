...
@Component({
  selector: 'app-scalate-risk',
  templateUrl: './scalate-risk.component.html',
  styleUrls: ['./scalate-risk.component.scss']
})
export class ScalateRiskComponent implements OnInit {

  riskId: number;
  selectedRisk: Risk;

  constructor(
    private dialogRef: MatDialogRef<ScalateRiskComponent>,
