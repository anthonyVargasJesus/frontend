...
export class MenuComponent implements OnInit {
  ...
  get() {
    this.loading = true;
    this.menuService.get(this.skip, this.pageSize, this.searchText)
      .subscribe((res: any) => {
  ...
  add() {
    ...
    if (this.loginService.isAuthenticated()) {
      let dialogRef = this.dialog.open(AddMenuComponent, {
        height: '450px',
        width: '450px',
  ...
  delete(menu: Menu) {
    ...
    let text: string;
    text = '¿Esta seguro de eliminar la menu ' + menu.name + '?';
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.menuService.delete(menu.menuId)
          .subscribe(deleted => {
            this.get();
          });
...
//MenuComponent, AddMenuComponent, EditMenuComponent
//{
//id: 'menu',
//title: '',
//translate: 'MENU.MENU',
