...
@Component({
  selector: 'app-documentation-support',
  templateUrl: './documentation-support.component.html',
  styles: [
  ]
})


export class DocumentationSupportComponent implements OnInit {
  ...
  edit(id: number, standardId: number) {
    this.router.navigate(['/current-standard/support-detail', id]);
  }
