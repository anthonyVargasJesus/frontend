...
export class LocationComponent implements OnInit {
  ...
  get() {
    this.loading = true;
    this.locationService.get(this.skip, this.pageSize, this.searchText)
      .subscribe((res: any) => {
  ...
  delete(location: Location) {
    ...
    let text: string;
    text = '¿Esta seguro de eliminar la location ' + location.name + '?';
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.locationService.delete(location.locationId)
          .subscribe(deleted => {
            this.get();
          });
